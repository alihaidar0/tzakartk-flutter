...
class EmailVerificationBottomSheetWidget extends StatefulWidget {
  final GlobalKey<ScaffoldState> scaffoldKey;
  final userModel.User user;

  EmailVerificationBottomSheetWidget({Key key, this.scaffoldKey, this.user}) : super(key: key);

  @override
  _EmailVerificationBottomSheetWidgetState createState() => _EmailVerificationBottomSheetWidgetState();
}

class _EmailVerificationBottomSheetWidgetState extends State<EmailVerificationBottomSheetWidget> {
  String smsSent;
  String errorMessage;
